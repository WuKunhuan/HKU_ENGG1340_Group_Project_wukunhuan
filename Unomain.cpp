...
//Description: Implementation of Crazy Eights game (Similar to Uno). All Functions needed for this game is
//in this file.
#include <iostream>
#include <string>
#include <vector>
...
void PrintRules() {
    ...
    cout << "During a player's turn they can play a card the matches the top card in the Play pile by suit (i.e Diamonds, Hearts, Clover, Spade)" << endl;
...
int unomain(string name, int& playerscore) {
    ...
    cout << "=========================================" << endl;
    cout << "Round over. Thank you for playing!" << endl;
