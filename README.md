...
##  Compilation and execution instructions
    ...
    Sometimes, if nothing is coming up in the game, just return one more blank lines, and then it should be OK (the getline function sometimes let users to enter again in case the previous enter is nothing). Have fun with both subgames and try different game modes  :)
